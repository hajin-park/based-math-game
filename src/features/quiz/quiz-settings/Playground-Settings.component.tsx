...
interface PlaygroundSettingsProps {
    onStartQuiz: (settings: { questions: QuestionSetting[]; duration: number }) => void;
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-3">
                ...
                <Form {...startForm}>
                    <form onSubmit={startForm.handleSubmit(onSubmitStart)} className="space-y-4">
                        {/* Question Settings Table */}
                        <div className="space-y-2">
                            <label className="text-sm font-medium">Question Types ({chosenSettings.length})</label>
                            <ChosenSettingsTable
