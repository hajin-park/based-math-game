        ...
        <TabsContent value="binary" className="space-y-6 animate-in">
          <Card className="border-2 shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              {/* Counting */}
              <div>
                <h3 className="text-lg font-semibold mb-3">Counting in Binary</h3>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <label className="text-sm font-medium mb-2 block">Binary Input:</label>
                    <Input
                      value={binaryInput}
        ...
        <TabsContent value="octal" className="space-y-6 animate-in">
          <Card className="border-2 shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              {/* Counting */}
              <div>
                <h3 className="text-lg font-semibold mb-3">Counting in Octal</h3>
                <div className="grid grid-cols-4 md:grid-cols-8 gap-2">
                  {Array.from({ length: 16 }, (_, i) => ({
                    dec: i,
                    oct: i.toString(8),
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <label className="text-sm font-medium mb-2 block">Octal Input:</label>
                    <Input
                      value={octalInput}
                  ...
                  <div className="grid gap-3 md:grid-cols-3">
                    ...
                    <div className="bg-muted p-3 rounded-lg">
                      <p className="text-xs font-semibold mb-1">Hexadecimal</p>
                      <p className="font-mono text-lg font-bold">
                        {octalInput ? parseInt(octalInput, 8).toString(16).toUpperCase() : '0'}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <Card className="border-2 shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <label className="text-sm font-medium mb-2 block">Decimal Input:</label>
                    <Input
                      value={decimalInput}
                      onChange={(e) => setDecimalInput(e.target.value.replace(/[^0-9]/g, ''))}
        ...
        <TabsContent value="hex" className="space-y-6 animate-in">
          <Card className="border-2 shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              {/* Counting */}
              <div>
                <h3 className="text-lg font-semibold mb-3">Counting in Hexadecimal</h3>
                <div className="grid grid-cols-4 md:grid-cols-8 gap-2">
                  {Array.from({ length: 16 }, (_, i) => ({
                    dec: i,
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <label className="text-sm font-medium mb-2 block">Hexadecimal Input:</label>
                    <Input
                      value={hexInput}
