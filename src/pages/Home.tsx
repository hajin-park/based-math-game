  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="text-center space-y-3 animate-in">
              ...
              <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed annotation">
                Practice converting between Binary, Octal, Decimal, and
                Hexadecimal through timed challenges and speed runs
              </p>
            </div>
      ...
      <motion.section
        ...
        animate={
          howToPlayVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }
        }
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
          <StickyNote
            variant="info"
            size="default"
            className="hover:rotate-0 hover:-translate-y-1 transition-all"
          >
            <StickyNoteTitle>1. Choose a Mode</StickyNoteTitle>
            <StickyNoteDescription>
              Select from 48 official game modes or create your own custom
              challenge with specific bases and difficulty levels
            </StickyNoteDescription>
          </StickyNote>
          ...
          >
            ...
            <StickyNoteDescription>
              Type your answers to convert between Binary, Octal, Decimal, and
              Hexadecimal as fast as you can
            </StickyNoteDescription>
          </StickyNote>
          ...
          >
            ...
            <StickyNoteDescription>
              Track your progress, compete on leaderboards, and improve your
              conversion speed over time
            </StickyNoteDescription>
          </StickyNote>
        </div>
      ...
      >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Carefully designed challenges from beginner to hard level
                </p>
              </div>
            </div>
          </PaperCard>
          ...
          <PaperCard padding="default" className="text-center torn-edge-top">
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Real-time multiplayer mode to show off your skills
                </p>
              </div>
            </div>
          </PaperCard>
          ...
          <PaperCard
            padding="default"
            className="text-center sm:col-span-2 lg:col-span-1 torn-edge-top"
          >
            <div className="space-y-3">
              ...
              <div>
                <h3 className="font-serif font-semibold text-lg mb-1">
                  <span className="highlight-scribble highlight-scribble-orange">
                    Timed & Speed Runs
                  </span>
                </h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Challenge yourself with time limits or race to answer
                  questions
                </p>
              </div>
            </div>
      ...
      >
        <div className="max-w-3xl mx-auto text-center space-y-5">
          <div className="space-y-2">
            <h2 className="text-3xl md:text-4xl font-serif font-bold ink-underline-visible">
              Ready to Start?
            </h2>
